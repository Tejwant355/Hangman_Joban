...
{
    [Activity(Label = "My_Hangman_Game_Activity")]
    public class My_Hangman_Game_Activity : Activity
    {

        private Button btnAll_Scoree;
        //Buttons A-Z
        private Button btnA;
        private Button btnB;
        private Button btnC;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.My_Game_Layout );
            LoadDictionaryWords();
            ...
            btnAll_Scoree = FindViewById<Button>(Resource.Id.btnAll_Scoree);
            btnAll_Scoree.Click += BtnAll_Scoree_Click;
        ...
        private void BtnAll_Scoree_Click(object sender, EventArgs e)
        {
            StartActivity(typeof(My_All_Score_Activity));
        }
        ...
        private void DefaultImage()
        {
            ...
            imgHangman.SetImageResource(Resource.Drawable.default_pic);
        }
